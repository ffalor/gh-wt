...
* [gh_wt_completion_install](/gh-wt/docs/cli/gh_wt_completion_install)	 - Install shell completion for the detected shell

* [gh_wt_completion_uninstall](/gh-wt/docs/cli/gh_wt_completion_uninstall)	 - Uninstall shell completion for the detected shell
